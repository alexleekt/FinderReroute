...
iconset_dir = "/Users/alexleekt/git/FinderReroute/FinderReroute.app/Contents/Resources/AppIcon.iconset"
...
print("\nCreating ICNS file...")
icns_path = "/Users/alexleekt/git/FinderReroute/FinderReroute.app/Contents/Resources/AppIcon.icns"
...
if result == 0:
    ...
    import shutil
    shutil.copy(f"{iconset_dir}/icon_512x512@2x.png", "/Users/alexleekt/git/FinderReroute/FinderReroute.app/Contents/Resources/AppIcon.png")
    os.system(f"rm -rf {iconset_dir}")
